        ...
        private var userPhoto: some View {
            ...
            return VStack(alignment: .center) {
                if selectedImage == nil {
                    if !viewModel.state.user!.image.isEmpty {
                        Image(uiImage: FileHelper().loadImage(fileName: viewModel.state.user!.image)!)
                            .resizable()
                            .scaledToFill()
